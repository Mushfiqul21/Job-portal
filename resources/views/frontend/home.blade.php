...
@section('main')
    <section class="section-0 lazy d-flex bg-image-style dark align-items-center "   class="" data-bg="{{ asset('images/'.$hero->bg_image) }}">
        <div class="container">
            <div class="row">
    ...
    <section class="section-1 py-5 ">
        <div class="container">
            <div class="card border-0 shadow p-5">
                <form action="{{ route('job.jobs') }}" method="get">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3 mb-sm-3 mb-lg-0">
                            <select name="category" id="category" class="form-control">
                                ...
                                @if($new_category->isNotEmpty())
                                    @foreach($new_category as $new_cate)
                                        <option value="{{$new_cate->id}}">{{$new_cate->name}}</option>
                                    @endforeach
                                @endif
                            </select>
                        </div>
                    ...
                    @foreach($categories as $category)
                        <div class="col-lg-4 col-xl-3 col-md-6">
                            <div class="single_catagory">
                                <a href="{{ route('job.jobs').'?category='.$category->id }}"><h4 class="pb-2">{{ $category->name }}</h4></a>
